    ...
    return [
      {
        ...
        paragraphs: [
          '一、协议的确认与接受',
          '1.1本协议由用户（以下简称“您”）与小舟摇软件（以下简称“平台”）就您使用平台所提供的相关服务所订立，具有法律约束力。',
          '1.2在您注册、下载、安装、登录、使用平台服务或以其他方式接受平台服务之前，请您务必仔细阅读并充分理解本协议所有条款，特别是涉及免除或限制责任、权利义务、争议解决的条款。',
          '1.3当您点击“同意”或以其他形式使用平台服务，即视为您已阅读、理解并同意接受本协议的全部内容；若您不同意本协议的任何条款，请立即停止使用平台服务。'
        ]
      },
      {
        title: '二、服务内容',
        paragraphs: [
          '2.1平台向您提供的服务包括但不限于：',
          '2.1.1用户注册、登录、账户管理；',
          '2.1.2 APP的下载、安装、更新与升级；',
          '2.1.3用户信息的查询、编辑与修改；',
          '2.1.4系统通知、消息推送与提醒；',
          '2.1.5用户隐私保护与信息安全管理；',
          '2.1.6用户协议与服务条款的展示与解释。',
          '2.2平台有权根据运营情况和法律法规的要求，随时对服务内容进行新增、变更、中断或终止，无需事先通知用户。',
          '2.3用户在使用平台新增服务时，仍应遵守本协议的约定，除非另有明确说明。'
        ]
      },
      {
        title: '三、用户权利与义务',
        paragraphs: [
          '3.1用户有权在遵守本协议及相关规则的前提下使用平台服务。',
          '3.2用户在使用平台服务过程中，应当遵守中华人民共和国相关法律法规及社会公序良俗，不得利用平台从事任何违法违规行为，包括但不限于：',
          '3.2.1 发布、传输或存储违法、违规内容；',
          '3.2.2 侵害他人知识产权、隐私权或其他合法权益；',
          '3.2.3 恶意注册账号、伪造身份、传播恶意软件；',
          '3.2.4 干扰、破坏平台正常运行。',
          '3.3用户应妥善保管账号及密码，不得出租、出借或转让账号。因用户保管不善导致的损失由用户自行承担。',
          '3.4用户保证所填写、提交的个人资料真实、准确、完整，并及时更新。如因提供虚假信息造成的后果，由用户自行承担。'
        ]
      },
      {
        title: '四、平台权利与义务',
        paragraphs: [
          '4.1平台有权对用户的使用行为进行监督，如发现用户违反本协议或相关法律法规的，有权采取警告、限制、冻结、终止服务等措施。',
          '4.2平台将持续优化和改进服务，但不保证服务的绝对无误、连续性或满足用户特定需求。',
          '4.3平台有权通过公告、邮件、短信、系统通知等方式向用户发送与服务相关的信息。',
          '4.4平台将依据法律法规的规定，采取必要措施保护用户个人信息的安全，但在符合法律法规或政府机关要求时，有权披露相关信息。'
        ]
      },
      {
        title: '五、知识产权',
        paragraphs: [
          '5.1平台在服务中使用的所有软件、技术、界面设计、文字、图像、视频、音频等内容，其知识产权归平台或相关权利人所有。未经许可，用户不得复制、传播、修改、反向工程或用于商业目的。',
          '5.2用户在使用平台过程中生成的内容，其知识产权归用户本人或原始权利人所有。但用户同意授予平台在法律允许的范围内，出于提供服务之必要而进行使用、存储、展示的权利。',
          '5.3用户不得以任何形式侵犯平台或第三方的知识产权，若因用户行为导致纠纷，责任由用户自行承担。'
        ]
      },
      {
        title: '六、协议的变更与终止',
        paragraphs: [
          '6.1平台有权根据法律法规及运营需要对本协议进行修改，并通过公告或其他适当方式告知用户。修改后的协议一经公布即生效。',
          '6.2若用户不同意修改内容，有权停止使用平台服务；若继续使用，则视为接受修改后的协议。',
          '6.3平台有权随时基于自身判断中止或终止对用户的服务，用户也有权随时注销账号并终止本协议。'
        ]
      },
      {
        title: '七、免责条款',
        paragraphs: [
          '7.1用户在使用平台服务过程中应自行承担风险。',
          '7.2对因不可抗力或非平台原因（包括但不限于自然灾害、网络故障、病毒攻击、系统问题、第三方服务问题等）导致的损失，平台不承担责任。',
          '7.3因用户自身行为或第三方原因造成的损失，平台不承担任何直接或间接责任。'
        ]
      },
      {
        title: '八、争议解决',
        paragraphs: [
          '8.1本协议的订立、生效、履行、解释及争议解决，均适用中华人民共和国法律。',
          '8.2因本协议引起的或与本协议有关的争议，双方应友好协商解决；协商不成的，应提交平台所在地有管辖权的人民法院诉讼解决。'
        ]
      },
      {
        title: '九、其他',
        paragraphs: [
          '9.1本协议的部分条款因任何原因被认定为无效或不可执行，不影响其余条款的效力。',
          '9.2本协议的最终解释权归平台所有。'
        ]
      }
    ];
    ...
    return [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '1.2若您使用第三方账号登录（如微信/支付宝/Apple ID 等），在您授权后我们将获取第三方提供的头像、昵称、地区/性别（如有）以完成账号绑定；如需关联会员权益，可能仍需收集您的手机号码。',
          '1.3您可自愿完善个人资料（如头像、昵称、性别、年级等）；不提供不影响基础使用。',
          '2. 功能使用与设备权限',
          '为实现特定功能，我们可能调用以下权限：',
